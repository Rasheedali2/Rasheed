...
def xyz():
    ...
    print(f"")
    print(f"\033[1;91m========================================================")
    Rasheed = input("[√] CHOOSE : ")
    if Rasheed in ["1","01"]:
        Random()
    elif RASHEED in ["0","00"]:
       exit()
    else:
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[RASHEED] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
